...
void main()
{
    ...
    else
    {
        ...
        // the texture - matches the original ES1-era behaviour exactly.
        FRAGCOLOR  = processLight(v_colour, normal, u_lightDir[0], u_lightDiffuseColour[0], u_lightSpecularColour[0], u_lightAmbientColour[0], u_specularAmount, u_specularExponent);
