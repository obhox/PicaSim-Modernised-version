...
class btRigidBody  : public btCollisionObject
{
	...
	btVector3		m_extraLocalAngularMomentum;
...
public:
	...
	const btVector3& getExtraLocalAngularMomentum() const
	{
		return m_extraLocalAngularMomentum;
	};

	void setExtraLocalAngularMomentum(const btVector3& extraLocalAngularMomentum)
	{
		m_extraLocalAngularMomentum = extraLocalAngularMomentum;
	};
  ...
  btMatrix3x3 getWorldInertiaTensor() const;
