...
{
  btAssert(witnessPointA != btVector3(FLT_MAX, FLT_MAX, FLT_MAX));
  btAssert(witnessPointB != btVector3(FLT_MAX, FLT_MAX, FLT_MAX));
	btScalar Min0,Max0;
	btScalar Min1,Max1;
...
//#endif
	...
	int edgeA=-1;
	int edgeB=-1;
	btVector3 worldEdgeA(FLT_MAX, FLT_MAX, FLT_MAX);
	btVector3 worldEdgeB(FLT_MAX, FLT_MAX, FLT_MAX);
	btVector3 witnessPointA(FLT_MAX, FLT_MAX, FLT_MAX);
  btVector3 witnessPointB(FLT_MAX, FLT_MAX, FLT_MAX);
...
//		printf("edge-edge\n");
    ...
    btAssert(worldEdgeA != btVector3(FLT_MAX, FLT_MAX, FLT_MAX));
    btAssert(worldEdgeB != btVector3(FLT_MAX, FLT_MAX, FLT_MAX));
